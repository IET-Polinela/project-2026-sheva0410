const routes = {
        ...
        <div class="row justify-content-center mt-5">
            <div class="col-12 col-md-5 col-lg-4 spa-card card shadow-lg p-4 rounded-4">
                ...
                <div class="text-center mt-3">
                    ...
                    <button class="btn btn-link text-white fw-semibold p-0 ms-1" type="button" onclick="window.location.hash='#register'">Daftar</button>
                </div>
            </div>
        </div>
    `,
        ...
        <div class="row justify-content-center mt-5">
            <div class="col-12 col-md-5 col-lg-4 spa-card card shadow-lg p-4 rounded-4">
                ...
                <form id="registerForm">
                    <input type="text" id="registerUsername" class="form-control mb-3" placeholder="Username" required>
                    <input type="email" id="registerEmail" class="form-control mb-3" placeholder="Email" required>
                ...
                <div class="text-center mt-3">
                    ...
                    <button class="btn btn-link text-white fw-semibold p-0 ms-1" type="button" onclick="window.location.hash='#login'">Login</button>
                </div>
            </div>
        </div>
    `,
    ...
    '#dashboard': `
        <section class="hero-card text-center p-5 mb-4 shadow-lg">
            <h1 class="fw-bold display-5">Bandar Lampung Smart City Reporting</h1>
            <p class="lead text-soft">Laporkan permasalahan kota dengan cepat dan mudah</p>
        </section>
        ...
        <div class="row g-4">
            ...
            <aside class="col-12 col-lg-3">
                <div class="spa-card card border-0 shadow-sm rounded-4 p-3 sticky-top" style="top: 20px;">
                    ...
                    <button class="btn btn-purple w-100 mb-3 fw-semibold" id="btnBukaModal" type="button">
                        <i class="bi bi-plus-circle-fill me-2"></i>
                        Laporan Baru
                    </button>

                    <div class="small text-soft mb-3">Buat laporan baru sebagai draft sebelum dikirim.</div>
                    ...
                    <div id="summaryStats">
                        <div class="d-flex justify-content-between mb-2">
                            <span class="text-soft"><i class="bi bi-pencil-square me-1"></i>Draft</span>
                            <span class="badge bg-secondary" id="draftCount">0</span>
                        </div>
                        <div class="d-flex justify-content-between mb-2">
                            <span class="text-soft"><i class="bi bi-send-fill me-1"></i>Diajukan</span>
                            <span class="badge bg-primary" id="reportedCount">0</span>
                        </div>
                        <div class="d-flex justify-content-between mb-2">
                            <span class="text-soft"><i class="bi bi-patch-check-fill me-1"></i>Terverifikasi</span>
                            <span class="badge bg-info text-dark" id="verifiedCount">0</span>
                        </div>
                        <div class="d-flex justify-content-between mb-2">
                            <span class="text-soft"><i class="bi bi-gear-fill me-1"></i>Diproses</span>
                            <span class="badge bg-warning text-dark" id="progressCount">0</span>
                        </div>
                        <div class="d-flex justify-content-between">
                            <span class="text-soft"><i class="bi bi-check-circle-fill me-1"></i>Selesai</span>
            ...
            <section class="col-12 col-lg-6">
                <div class="spa-card card border-0 shadow-sm rounded-4 p-3 mb-3">
                    <ul class="nav nav-pills gap-2" id="reportTabs">
                        <li class="nav-item">
                            <button class="nav-link active" id="myReportsTab" type="button" data-tab="my_reports">
                                <i class="bi bi-person-lines-fill me-1"></i>
                                Laporan Saya
                            </button>
                        </li>
                        <li class="nav-item">
                            <button class="nav-link" id="tabFeedKota" type="button" data-tab="feed">
